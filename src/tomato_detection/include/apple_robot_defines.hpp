...
const std::string pos2gazebo = "/arm_left_controller/follow_joint_trajectory/goal";
const std::string pos2gazebo_sim = "/arm_velocity_trajectory_controller/follow_joint_trajectory/goal";
